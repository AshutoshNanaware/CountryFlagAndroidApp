    ...
    private View initView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(
                    R.layout.custome_spinner, parent, false
            );
        }
        ...
        if (currentItem != null) {
     //      imageViewFlag.setImageURI(Uri.parse(currentItem.getFlagImage()));
            Picasso.get().load((String) currentItem.getFlagImage()).into(imageViewFlag);
